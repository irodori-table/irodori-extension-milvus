...
| `userPassword` | ユーザー名/パスワード | `userPassword` | `password` |
...
- インスパイア元: Milvus コレクション、Milvus インデックス、Milvus スカラー フィルタリング
...
| テンプレート | ラベル | 言語 | 結果ビュー |
| --- | --- | --- | --- |
| `vector-similarity` | Milvus ベクトル検索 | `json` | `vectorNeighbors` |
| `vector-filtered` | Milvus フィルタ付き検索 | `json` | `vectorNeighbors` |
| `vector-health` | Milvus コレクション統計 | `text` | `table` |
